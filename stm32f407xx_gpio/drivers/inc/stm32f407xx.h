...
/*
 * ARM CORTEX Mx PROCESSOR NVIC ISERx (SET INTERRUPT) REGISTER ADDRESS
 */
...
/*
 * ARM CORTEX Mx PROCESSOR NVIC ICERx (CLEAR INTERRUPT) REGISTER ADDRESS
 */
...
/*
 * ARM CORTEX Mx PROCESSOR NVIC IPRx (INTERRUPT PRIORITY) REGISTER ADDRESS
 */
...
/*
 * BASE ADDRESSSES OF FLASH AND SRAM MEMORIES
 */
...
#define SYSCFG				((SYSCFG_RegDdef_t*)SYSCFG_BASEADDR)
